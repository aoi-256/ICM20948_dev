...
uint8_t AK09916::getMagnet(float* data_box){
	...
	data_box[0]=(float)getMagnet_X() + 15.5;//*0.15f;
	data_box[1]=(float)getMagnet_Y() -547.0;//*0.15f;
	data_box[2]=(float)getMagnet_Z() -361.0;//*0.15f;
